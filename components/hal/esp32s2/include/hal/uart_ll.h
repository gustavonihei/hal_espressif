 ...
 */
FORCE_INLINE_ATTR uint32_t uart_ll_get_sclk_freq(hal_uart_dev_t *hw)
{
 ...
 * @return None
 */
FORCE_INLINE_ATTR void uart_ll_set_baudrate(hal_uart_dev_t *hw, uint32_t baud)
{
 ...
 */
FORCE_INLINE_ATTR uint32_t uart_ll_get_baudrate(hal_uart_dev_t *hw)
{
